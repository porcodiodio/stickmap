      ...
      <div className="bg-[#0a0a0a] w-full max-w-md rounded-[32px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] border border-white/10 overflow-hidden flex flex-col max-h-[90vh] mesh-gradient relative">
        ...
        <div className="px-8 pt-10 pb-6 flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-light tracking-tight text-white mb-1">
            {isLogin ? 'Bon ' : 'Créer un '}
            <span className="font-bold">{isLogin ? 'Retour' : 'Compte'}</span>
          </h2>
          <p className="text-white/40 text-[10px] uppercase tracking-widest font-bold">Rejoignez la communauté mondiale</p>
        </div>
        ...
        <div className="px-8 pb-10 overflow-y-auto space-y-6">
          ...
          <div className="relative flex items-center">
            ...
            <span className="flex-shrink mx-4 text-white/20 text-[10px] font-bold uppercase tracking-widest">Ou via email</span>
            <div className="flex-grow border-t border-white/5"></div>
          </div>
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-[10px] text-white/40 uppercase tracking-widest font-bold ml-2">Email</label>
              <div className="glass-panel rounded-[24px] p-1 border-white/5 focus-within:border-white/20 transition-all">
                <input
                  type="email"
                  required
            ...
            <div className="space-y-2">
              <label className="text-[10px] text-white/40 uppercase tracking-widest font-bold ml-2">Mot de passe</label>
              <div className="glass-panel rounded-[24px] p-1 border-white/5 focus-within:border-white/20 transition-all">
                <input
                  type="password"
                  required
          ...
          <div className="text-center">
            ...
            >
              {isLogin ? "Créer un compte" : "Déjà membre ? Se connecter"}
            </button>
          </div>
        </div>
      </div>
